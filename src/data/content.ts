...
export const marketing = {
  en: {
    ...
    home: {
      ...
      closingTitle: 'Bring the system that refuses to explain itself.', closingBody: 'For engineering roles, consulting, or a precise technical collaboration, send the constraint and the evidence you already have.', closingCta: 'Start a conversation', closingAlt: 'View all work', quoteCta: 'Build a project brief',
    },
    ...
    services: { title: 'Small enough to govern. Deep enough to matter.', intro: 'Every engagement starts with the actual constraint and ends with inspectable evidence. Prices are fixed starting points; scope stays explicit.', priceNote: 'Investment', fit: 'Useful when', includes: 'What you receive', cta: 'Quote this service', quoteCta: 'Get a quote', fixedPrice: 'Fixed price', duration: 'Duration', evidenceLabel: 'Evidence', evidenceTitle: 'Numbers from the work history, not from a brochure.', evidenceIntro: 'Each figure names the employer and the period. Client systems stay confidential; the measurements do not.', invoiceLabel: 'Invoicing', invoiceNote: 'Prices exclude taxes. A CFDI invoice is available; Mexican entities add 16% IVA. MXN prices are fixed for the engagement, not a daily exchange rate.', boundary: 'No hidden handoff: decisions, access, production changes, and irreversible actions stay with you.' },
    ...
    contact: { title: 'Tell me what the system is doing—not what you wish it did.', intro: 'Hiring? The work history, PDF, and a Markdown copy are one tab away. Consulting? Build a project brief and hand it off by WhatsApp or email.', whatsapp: 'Message on WhatsApp', email: 'Send an email', linkedin: 'Open LinkedIn', github: 'Browse GitHub', note: 'Please do not send credentials, customer data, or production secrets.', hiring: { eyebrow: 'DOSSIER / HIRING', title: 'The résumé, in the open.', intro: 'Four roles from backend delivery to performance leadership, with the numbers as they appear in the work history. Download the PDF or copy the Markdown into your tracker.', download: 'Download PDF', copy: 'Copy as Markdown', copied: 'Markdown copied.', copyFailed: 'Copy was unavailable. Open the PDF instead.', fullHistory: 'Complete experience', education: 'Education' } },
  ...
  es: {
    ...
    home: {
      ...
      closingTitle: 'Trae el sistema que se niega a explicar su comportamiento.', closingBody: 'Para roles de ingeniería, consultoría o una colaboración técnica precisa, comparte la restricción y la evidencia que ya tienes.', closingCta: 'Iniciar conversación', closingAlt: 'Ver todo el trabajo', quoteCta: 'Construir un brief de proyecto',
    },
    ...
    services: { title: 'Lo bastante pequeño para gobernarlo. Lo bastante profundo para importar.', intro: 'Cada colaboración parte de la restricción real y termina con evidencia inspeccionable. Los precios son puntos de partida fijos; el alcance permanece explícito.', priceNote: 'Inversión', fit: 'Útil cuando', includes: 'Lo que recibes', cta: 'Cotizar este servicio', quoteCta: 'Cotizar', fixedPrice: 'Precio fijo', duration: 'Duración', evidenceLabel: 'Evidencia', evidenceTitle: 'Cifras del historial profesional, no de un folleto.', evidenceIntro: 'Cada cifra nombra al empleador y el periodo. Los sistemas de clientes son confidenciales; las mediciones no.', invoiceLabel: 'Facturación', invoiceNote: 'Precios sin IVA. Se emite factura CFDI; para entidades mexicanas se agrega 16 % de IVA. El precio en MXN es fijo para el proyecto, no un tipo de cambio diario.', boundary: 'Sin entrega oculta: decisiones, accesos, producción y acciones irreversibles permanecen bajo tu control.' },
    ...
    contact: { title: 'Cuéntame qué hace el sistema, no qué desearías que hiciera.', intro: '¿Contratas? El historial, el PDF y una copia en Markdown están a un clic. ¿Consultoría? Construye un resumen de proyecto y envíalo por WhatsApp o correo.', whatsapp: 'Escribir por WhatsApp', email: 'Enviar correo', linkedin: 'Abrir LinkedIn', github: 'Explorar GitHub', note: 'No envíes credenciales, datos de clientes ni secretos de producción.', hiring: { eyebrow: 'EXPEDIENTE / CONTRATAR', title: 'El currículum, a la vista.', intro: 'Cuatro roles, de entrega backend a liderazgo de rendimiento, con las cifras tal como aparecen en el historial. Descarga el PDF o copia el Markdown a tu sistema.', download: 'Descargar PDF', copy: 'Copiar como Markdown', copied: 'Markdown copiado.', copyFailed: 'No fue posible copiar. Abre el PDF.', fullHistory: 'Experiencia completa', education: 'Educación' } },
