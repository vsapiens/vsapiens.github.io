...
export const marketing = {
  en: {
    ...
    contact: { title: 'Tell me what the system is doing—not what you wish it did.', intro: 'Share the role, constraint, incident pattern, or product boundary. Email is the clearest starting point; LinkedIn and GitHub are available for context.', email: 'Send an email', linkedin: 'Open LinkedIn', github: 'Browse GitHub', note: 'Please do not send credentials, customer data, or production secrets.' },
  ...
  es: {
    ...
    contact: { title: 'Cuéntame qué hace el sistema, no qué desearías que hiciera.', intro: 'Comparte el rol, la restricción, el patrón del incidente o el límite del producto. El correo es el punto de partida más claro; LinkedIn y GitHub aportan contexto.', email: 'Enviar correo', linkedin: 'Abrir LinkedIn', github: 'Explorar GitHub', note: 'No envíes credenciales, datos de clientes ni secretos de producción.' },
